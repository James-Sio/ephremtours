...
import gallery14 from "../../imports/gallery-14.jpg"; // Secondary vehicle
import gallery15 from "../../imports/gallery-15.jpg"; // Secondary vehicle
import gallery16 from "../../imports/gallery-16.jpg"; // Secondary vehicle
...
const targetVehicles: ToyotaVehicle[] = [
  {
    ...
    image: gallery11,
    gallery: [gallery11, gallery14, gallery15],
    baseDailyRate: 8500,
    seats: "7 VIP Seats",
  ...
  },
  {
    ...
    image: gallery12,
    gallery: [gallery12, gallery16, gallery14],
    baseDailyRate: 6500,
  ...
  },
  {
    ...
    image: gallery9,
    gallery: [gallery9, gallery15, gallery16],
    baseDailyRate: 5500,
  ...
  },
  {
    ...
    image: gallery10,
    gallery: [gallery10, gallery14, gallery15],
    baseDailyRate: 5000,
  ...
  },
  {
    ...
    image: gallery13,
    gallery: [gallery13, gallery16, gallery14],
    baseDailyRate: 7500,
